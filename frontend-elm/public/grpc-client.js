(() => {
  ...
  var CreateSessionResponse$Type = class extends MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
      ...
      if (message.result.oneofKind === "error")
        Error2.internalBinaryWrite(message.result.error, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
      let u = options.writeUnknownFields;
      if (u !== false)
        (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
      return writer;
  ...
  var StartTurnRequest$Type = class extends MessageType {
      ...
      while (reader.pos < end) {
        ...
        switch (fieldNo) {
          ...
          1:
            message.sessionId = reader.string();
            break;
          case /* string forced_tile */
          2:
            message.forcedTile = reader.string();
            break;
          default:
            let u = options.readUnknownField;
            if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
      if (message.sessionId !== "")
        writer.tag(1, WireType.LengthDelimited).string(message.sessionId);
      if (message.forcedTile !== "")
        writer.tag(2, WireType.LengthDelimited).string(message.forcedTile);
      let u = options.writeUnknownFields;
      if (u !== false)
        (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
      return writer;
  ...
  var StartTurnResponse$Type = class extends MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
      ...
      if (message.error)
        Error2.internalBinaryWrite(message.error, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
      let u = options.writeUnknownFields;
      if (u !== false)
        (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
      return writer;
  ...
  var GetGameStateResponse$Type = class extends MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
      ...
      if (message.error)
        Error2.internalBinaryWrite(message.error, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
      let u = options.writeUnknownFields;
      if (u !== false)
        (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
      return writer;
  ...
  var GetAiMoveRequest$Type = class extends MessageType {
    constructor() {
      super("takeiteasygame.v1.GetAiMoveRequest", [
        {
          no: 1,
          name: "tile_code",
          kind: "scalar",
    ...
    internalBinaryRead(reader, length, options, target) {
      ...
      while (reader.pos < end) {
        let [fieldNo, wireType] = reader.tag();
        switch (fieldNo) {
          case /* string tile_code */
          1:
            message.tileCode = reader.string();
            break;
          case /* repeated string board_state */
          2:
            message.boardState.push(reader.string());
            break;
          case /* repeated int32 available_positions */
          3:
            if (wireType === WireType.LengthDelimited)
              for (let e = reader.int32() + reader.pos; reader.pos < e; )
                message.availablePositions.push(reader.int32());
            else
              message.availablePositions.push(reader.int32());
            break;
          case /* int32 turn_number */
    ...
    internalBinaryWrite(message, writer, options) {
      if (message.tileCode !== "")
        writer.tag(1, WireType.LengthDelimited).string(message.tileCode);
      for (let i = 0; i < message.boardState.length; i++)
        writer.tag(2, WireType.LengthDelimited).string(message.boardState[i]);
      if (message.availablePositions.length) {
        writer.tag(3, WireType.LengthDelimited).fork();
        for (let i = 0; i < message.availablePositions.length; i++)
          writer.int32(message.availablePositions[i]);
        writer.join();
      }
      if (message.turnNumber !== 0)
        writer.tag(4, WireType.Varint).int32(message.turnNumber);
  ...
  var GetAiMoveRequest = new GetAiMoveRequest$Type();
  var GetAiMoveResponse$Type = class extends MessageType {
    constructor() {
      super("takeiteasygame.v1.GetAiMoveResponse", [
        {
          no: 1,
          name: "success",
          kind: "scalar",
      ...
      while (reader.pos < end) {
        ...
        switch (fieldNo) {
          ...
          1:
            message.success = reader.bool();
            break;
          case /* int32 recommended_position */
          2:
            message.recommendedPosition = reader.int32();
            break;
          case /* takeiteasygame.v1.Error error */
          3:
            message.error = Error2.internalBinaryRead(reader, reader.uint32(), options, message.error);
    ...
    internalBinaryWrite(message, writer, options) {
      if (message.success !== false)
        writer.tag(1, WireType.Varint).bool(message.success);
      if (message.recommendedPosition !== 0)
        writer.tag(2, WireType.Varint).int32(message.recommendedPosition);
      if (message.error)
        Error2.internalBinaryWrite(message.error, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
      let u = options.writeUnknownFields;
      if (u !== false)
        (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
      return writer;
  ...
  var GetAiMoveResponse = new GetAiMoveResponse$Type();
  var GameService = new ServiceType("takeiteasygame.v1.GameService", [
    ...
    { name: "GetAiMove", options: {}, I: GetAiMoveRequest, O: GetAiMoveResponse }
  ]);
  ...
  var GameServiceClient = class {
     ...
     *
     * @generated from protobuf rpc: GetAiMove
     */
    getAiMove(input, options) {
  ...
  // src/grpc-client.ts
  var IS_PRODUCTION = typeof window !== "undefined" && window.location.hostname !== "localhost" && window.location.hostname !== "127.0.0.1";
  var GRPC_WEB_URL = IS_PRODUCTION ? `${window.location.protocol}//${window.location.host}` : "http://localhost:50052";
  var GrpcClient = class {
    ...
    async startTurn(sessionId, forcedTile) {
      try {
        const request = { sessionId };
        if (forcedTile) {
    ...
    async getAiMove(tileCode, boardState, availablePositions, turnNumber) {
      try {
        const request = {
          tileCode,
          boardState,
