...
var $author$project$Main$defaultGameModes = _List_fromArray(
	[
		{
		description: 'IA avec 50 simulations MCTS',
		difficulty: $elm$core$Maybe$Just('easy'),
		icon: '🎯',
		id: 'single-player-easy',
		name: 'Solo Facile',
		simulations: $elm$core$Maybe$Just(50)
	},
		{
		description: 'IA avec 150 simulations MCTS',
		difficulty: $elm$core$Maybe$Just('normal'),
		icon: '🎮',
		id: 'single-player-normal',
		name: 'Solo Normal',
		simulations: $elm$core$Maybe$Just(150)
	},
		{
		description: 'IA avec 500 simulations MCTS',
		difficulty: $elm$core$Maybe$Just('hard'),
		icon: '🔥',
		id: 'single-player-hard',
		name: 'Solo Difficile',
		simulations: $elm$core$Maybe$Just(500)
	},
...
var $author$project$Main$initialModel = F2(
	function (key, url) {
		return {
			...
			authError: '',
			authLoading: false,
			authView: $author$project$Main$Login,
...
var $author$project$Main$GameFinished = F3(
	function (a, b, c) {
		return {$: 'GameFinished', a: a, b: b, c: c};
	});
...
var $author$project$Main$MovePlayed = F2(
	function (a, b) {
		return {$: 'MovePlayed', a: a, b: b};
	});
...
var $author$project$Main$TurnStarted = F5(
	function (a, b, c, d, e) {
		return {$: 'TurnStarted', a: a, b: b, c: c, d: d, e: e};
	});
...
var $author$project$Main$JsGameFinished = F3(
	function (a, b, c) {
		return {$: 'JsGameFinished', a: a, b: b, c: c};
	});
...
var $author$project$Main$JsMovePlayed = F2(
	function (a, b) {
		return {$: 'JsMovePlayed', a: a, b: b};
	});
...
var $author$project$Main$JsTurnStarted = F5(
	function (a, b, c, d, e) {
		return {$: 'JsTurnStarted', a: a, b: b, c: c, d: d, e: e};
	});
...
var $author$project$Main$handleJsMessage = F2(
	function (value, model) {
		var _v10 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$jsMessageDecoder, value);
		if (_v10.$ === 'Ok') {
			var jsMsg = _v10.a;
			switch (jsMsg.$) {
				case 'JsLoginSuccess':
				...
				case 'JsMovePlayed':
					...
					return A2(
						$author$project$Main$update,
						A2($author$project$Main$MovePlayed, position, points),
						model);
		...
		switch (msg.$) {
			...
			case 'Logout':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentView: $author$project$Main$LoginView, isAuthenticated: false, token: $elm$core$Maybe$Nothing, user: $elm$core$Maybe$Nothing}),
					$author$project$Main$sendToJs(
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
			...
			case 'BackToModeSelection':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentView: $author$project$Main$ModeSelectionView, error: '', gameState: $elm$core$Maybe$Nothing, selectedGameMode: $elm$core$Maybe$Nothing, session: $elm$core$Maybe$Nothing, statusMessage: ''}),
					$elm$core$Platform$Cmd$none);
			case 'SetPlayerName':
				var name = msg.a;
				return _Utils_Tuple2(
			...
			case 'SessionCreated':
				...
				var isSoloMode = function () {
					var _v5 = model.selectedGameMode;
					if (_v5.$ === 'Just') {
						var mode = _v5.a;
			...
			case 'SessionLeft':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentView: $author$project$Main$ModeSelectionView, gameState: $elm$core$Maybe$Nothing, loading: false, session: $elm$core$Maybe$Nothing}),
					$elm$core$Platform$Cmd$none);
			case 'ReadySet':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							currentTile: $elm$core$Maybe$Just(tile),
							currentTileImage: $elm$core$Maybe$Just(tileImage),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							statusMessage: '+' + ($elm$core$String$fromInt(points) + ' points')
						}),
					function () {
			...
			case 'GameFinished':
				...
				var newGameState = A2(
					...
					function (gs) {
						return _Utils_update(
							gs,
							{
								players: A2(mergePlayerScores, gs.players, players),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aiPlateauTiles: aiTiles, gameState: newGameState, plateauTiles: playerTiles, statusMessage: 'Partie terminée!'}),
					$elm$core$Platform$Cmd$none);
			case 'GameError':
				var error = msg.a;
				return _Utils_Tuple2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										_Utils_eq(model.authView, $author$project$Main$Login) ? 'Connectez-vous pour jouer' : 'Créez votre compte')
									]))
							])),
						(model.authError !== '') ? A2(
						$elm$html$Html$div,
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$placeholder('votre@email.com'),
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$placeholder('Votre pseudo'),
												$elm$html$Html$Attributes$required(true),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										_Utils_eq(model.authView, $author$project$Main$Login) ? 'Pas encore de compte ? ' : 'Déjà un compte ? '),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												...
												$elm$html$Html$Events$onClick(
												$author$project$Main$SwitchAuthView(
													_Utils_eq(model.authView, $author$project$Main$Login) ? $author$project$Main$Register : $author$project$Main$Login)),
												$elm$html$Html$Attributes$disabled(model.authLoading)
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
												_Utils_eq(model.authView, $author$project$Main$Login) ? 'S\'inscrire' : 'Se connecter')
											]))
									]))
							])),
						A2(
				...
				[
					...
					if (_v1.$ === 'Just') {
						...
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('mode-details')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('simulations')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(
											$elm$core$String$fromInt(sims) + ' simulations MCTS')
										]))
								]));
					} else {
						return $elm$html$Html$text('');
										...
										if (_v1.$ === 'Just') {
											...
											return A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														'MCTS: ' + ($elm$core$String$fromInt(sims) + ' simulations'))
													]));
										} else {
											return $elm$html$Html$text('');
										}
