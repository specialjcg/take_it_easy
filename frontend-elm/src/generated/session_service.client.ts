...
import type { RestartSessionResponse } from "./session_service";
import type { RestartSessionRequest } from "./session_service";
...
export interface ISessionServiceClient {
     ...
     */
    restartSession(input: RestartSessionRequest, options?: RpcOptions): UnaryCall<RestartSessionRequest, RestartSessionResponse>;
}
/**
 * @generated from protobuf service takeiteasygame.v1.SessionService
 */
export class SessionServiceClient implements ISessionServiceClient, ServiceInfo {
    ...
    restartSession(input: RestartSessionRequest, options?: RpcOptions): UnaryCall<RestartSessionRequest, RestartSessionResponse> {
        ...
        return stackIntercept<RestartSessionRequest, RestartSessionResponse>("unary", this._transport, method, opt, input);
    }
}
