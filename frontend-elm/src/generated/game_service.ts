...
export interface StartTurnRequest {
    ...
    sessionId: string;
    /**
     * @generated from protobuf field: string forced_tile = 2
     */
    forcedTile: string; // Optionnel: forcer une tuile spécifique (ex: "168") pour mode Jeu Réel
}
/**
 ...
 *
 * @generated from protobuf message takeiteasygame.v1.GetAiMoveRequest
 */
export interface GetAiMoveRequest {
    /**
     * @generated from protobuf field: string tile_code = 1
     */
    tileCode: string; // Code de la tuile (ex: "168")
    /**
     * @generated from protobuf field: repeated string board_state = 2
     */
    boardState: string[]; // État du plateau IA (19 cases, "" = vide)
    /**
     * @generated from protobuf field: repeated int32 available_positions = 3
     */
    availablePositions: number[]; // Positions disponibles
    /**
     * @generated from protobuf field: int32 turn_number = 4
     */
    turnNumber: number; // Numéro du tour (0-18)
}
/**
 * @generated from protobuf message takeiteasygame.v1.GetAiMoveResponse
 */
export interface GetAiMoveResponse {
    ...
    success: boolean;
    /**
     * @generated from protobuf field: int32 recommended_position = 2
     */
    recommendedPosition: number; // Position recommandée par l'IA (0-18)
    /**
     * @generated from protobuf field: takeiteasygame.v1.Error error = 3
     */
    error?: Error;
}
...
class StartTurnRequest$Type extends MessageType<StartTurnRequest> {
    constructor() {
        super("takeiteasygame.v1.StartTurnRequest", [
            { no: 1, name: "session_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "forced_tile", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
// @generated message type with reflection information, may provide speed optimized methods
class GetAiMoveRequest$Type extends MessageType<GetAiMoveRequest> {
    constructor() {
        super("takeiteasygame.v1.GetAiMoveRequest", [
            { no: 1, name: "tile_code", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "board_state", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "available_positions", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 5 /*ScalarType.INT32*/ },
            { no: 4, name: "turn_number", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<GetAiMoveRequest>): GetAiMoveRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.tileCode = "";
        message.boardState = [];
        ...
        message.turnNumber = 0;
        if (value !== undefined)
            reflectionMergePartial<GetAiMoveRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetAiMoveRequest): GetAiMoveRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string tile_code */ 1:
                    message.tileCode = reader.string();
                    break;
                case /* repeated string board_state */ 2:
                    message.boardState.push(reader.string());
                    break;
                case /* repeated int32 available_positions */ 3:
    ...
    internalBinaryWrite(message: GetAiMoveRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string tile_code = 1; */
        if (message.tileCode !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.tileCode);
        /* repeated string board_state = 2; */
        for (let i = 0; i < message.boardState.length; i++)
            writer.tag(2, WireType.LengthDelimited).string(message.boardState[i]);
        /* repeated int32 available_positions = 3; */
...
/**
 * @generated MessageType for protobuf message takeiteasygame.v1.GetAiMoveRequest
 */
export const GetAiMoveRequest = new GetAiMoveRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetAiMoveResponse$Type extends MessageType<GetAiMoveResponse> {
    constructor() {
        super("takeiteasygame.v1.GetAiMoveResponse", [
            { no: 1, name: "success", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "recommended_position", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "error", kind: "message", T: () => Error }
        ]);
    }
    create(value?: PartialMessage<GetAiMoveResponse>): GetAiMoveResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.success = false;
        message.recommendedPosition = 0;
        if (value !== undefined)
            reflectionMergePartial<GetAiMoveResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetAiMoveResponse): GetAiMoveResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* bool success */ 1:
                    message.success = reader.bool();
                    break;
                case /* int32 recommended_position */ 2:
                    message.recommendedPosition = reader.int32();
                    break;
                case /* takeiteasygame.v1.Error error */ 3:
                    message.error = Error.internalBinaryRead(reader, reader.uint32(), options, message.error);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: GetAiMoveResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* int32 recommended_position = 2; */
        if (message.recommendedPosition !== 0)
            writer.tag(2, WireType.Varint).int32(message.recommendedPosition);
        /* takeiteasygame.v1.Error error = 3; */
        if (message.error)
...
/**
 * @generated MessageType for protobuf message takeiteasygame.v1.GetAiMoveResponse
 */
export const GetAiMoveResponse = new GetAiMoveResponse$Type();
/**
