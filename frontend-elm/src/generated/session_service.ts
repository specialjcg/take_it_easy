...
/**
 * @generated from protobuf message takeiteasygame.v1.RestartSessionRequest
 */
...
/**
 * @generated from protobuf message takeiteasygame.v1.RestartSessionResponse
 */
...
// @generated message type with reflection information, may provide speed optimized methods
class RestartSessionRequest$Type extends MessageType<RestartSessionRequest> {
    constructor() {
    ...
    create(value?: PartialMessage<RestartSessionRequest>): RestartSessionRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.sessionId = "";
        message.playerId = "";
        if (value !== undefined)
            reflectionMergePartial<RestartSessionRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RestartSessionRequest): RestartSessionRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: RestartSessionRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string session_id = 1; */
        if (message.sessionId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.sessionId);
        /* string player_id = 2; */
...
/**
 * @generated MessageType for protobuf message takeiteasygame.v1.RestartSessionRequest
 */
export const RestartSessionRequest = new RestartSessionRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RestartSessionResponse$Type extends MessageType<RestartSessionResponse> {
    constructor() {
    ...
    create(value?: PartialMessage<RestartSessionResponse>): RestartSessionResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.success = false;
        if (value !== undefined)
            reflectionMergePartial<RestartSessionResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RestartSessionResponse): RestartSessionResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: RestartSessionResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* takeiteasygame.v1.Error error = 2; */
...
/**
 * @generated MessageType for protobuf message takeiteasygame.v1.RestartSessionResponse
 */
export const RestartSessionResponse = new RestartSessionResponse$Type();
/**
