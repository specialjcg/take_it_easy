...
import type { GetAiMoveResponse } from "./game_service";
import type { GetAiMoveRequest } from "./game_service";
...
export interface IGameServiceClient {
     ...
     */
    getAiMove(input: GetAiMoveRequest, options?: RpcOptions): UnaryCall<GetAiMoveRequest, GetAiMoveResponse>;
}
/**
 * @generated from protobuf service takeiteasygame.v1.GameService
 */
export class GameServiceClient implements IGameServiceClient, ServiceInfo {
    ...
    getAiMove(input: GetAiMoveRequest, options?: RpcOptions): UnaryCall<GetAiMoveRequest, GetAiMoveResponse> {
        ...
        return stackIntercept<GetAiMoveRequest, GetAiMoveResponse>("unary", this._transport, method, opt, input);
    }
}
